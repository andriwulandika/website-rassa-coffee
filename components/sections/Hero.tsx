  ...
  return (
    <section className="relative flex min-h-[90vh] w-full items-center justify-center overflow-hidden bg-background">
      ...
      <div className="relative mx-auto flex max-w-3xl flex-col items-center gap-6 px-6 py-24 text-center sm:gap-8">
        <span className="rounded-full border border-accent/40 bg-accent/10 px-4 py-1.5 text-xs font-medium uppercase tracking-[0.2em] text-primary">
          Coffee Shop &amp; B2B Supplier
        </span>

        <h1 className="text-4xl font-semibold leading-tight tracking-tight text-primary sm:text-5xl md:text-6xl">
          Kopi Premium,
          <br />
          Cerita Kutacane
        </h1>
